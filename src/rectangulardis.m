function varargout = rectangulardis(varargin)
% RECTANGULARDIS MATLAB code for rectangulardis.fig
%      RECTANGULARDIS, by itself, creates a new RECTANGULARDIS or raises the existing
%      singleton*.
%
%      H = RECTANGULARDIS returns the handle to a new RECTANGULARDIS or the handle to
%      the existing singleton*.
%
%      RECTANGULARDIS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in RECTANGULARDIS.M with the given input arguments.
%
%      RECTANGULARDIS('Property','Value',...) creates a new RECTANGULARDIS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before rectangulardis_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to rectangulardis_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help rectangulardis

% Last Modified by GUIDE v2.5 03-Nov-2021 18:42:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @rectangulardis_OpeningFcn, ...
                   'gui_OutputFcn',  @rectangulardis_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before rectangulardis is made visible.
function rectangulardis_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to rectangulardis (see VARARGIN)

% Choose default command line output for rectangulardis
...
% UIWAIT makes rectangulardis wait for user response (see UIRESUME)
...
function varargout = rectangulardis_OutputFcn(hObject, eventdata, handles) 
...
stem(n,x),grid on%Gráfica
xlabel('Tiempo (s)'),ylabel('Amplitud'), title('señal Rectángular')

function varargout = senoidedis(varargin)
% SENOIDEDIS MATLAB code for senoidedis.fig
%      SENOIDEDIS, by itself, creates a new SENOIDEDIS or raises the existing
%      singleton*.
%
%      H = SENOIDEDIS returns the handle to a new SENOIDEDIS or the handle to
%      the existing singleton*.
%
%      SENOIDEDIS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SENOIDEDIS.M with the given input arguments.
%
%      SENOIDEDIS('Property','Value',...) creates a new SENOIDEDIS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before senoidedis_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to senoidedis_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help senoidedis

% Last Modified by GUIDE v2.5 03-Nov-2021 18:40:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @senoidedis_OpeningFcn, ...
                   'gui_OutputFcn',  @senoidedis_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before senoidedis is made visible.
function senoidedis_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to senoidedis (see VARARGIN)

% Choose default command line output for senoidedis
...
% UIWAIT makes senoidedis wait for user response (see UIRESUME)
...
function varargout = senoidedis_OutputFcn(hObject, eventdata, handles) 
...
x = A*cos(2*pi*f*n-phi2); %Generación de Señal

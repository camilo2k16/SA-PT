function varargout = triangulocon(varargin)
% TRIANGULOCON MATLAB code for triangulocon.fig
%      TRIANGULOCON, by itself, creates a new TRIANGULOCON or raises the existing
%      singleton*.
%
%      H = TRIANGULOCON returns the handle to a new TRIANGULOCON or the handle to
%      the existing singleton*.
%
%      TRIANGULOCON('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TRIANGULOCON.M with the given input arguments.
%
%      TRIANGULOCON('Property','Value',...) creates a new TRIANGULOCON or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before triangulocon_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to triangulocon_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help triangulocon

% Last Modified by GUIDE v2.5 03-Nov-2021 19:05:40

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @triangulocon_OpeningFcn, ...
                   'gui_OutputFcn',  @triangulocon_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before triangulocon is made visible.
function triangulocon_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to triangulocon (see VARARGIN)

% Choose default command line output for triangulocon
...
% UIWAIT makes triangulocon wait for user response (see UIRESUME)
...
function varargout = triangulocon_OutputFcn(hObject, eventdata, handles) 
